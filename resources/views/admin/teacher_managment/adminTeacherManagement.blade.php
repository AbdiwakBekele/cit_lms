            ...
            <nav class="navbar navbar-dark bg-primary align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            <!-- Teacher Managment -->
                            <a class="nav-link text-start bg-white active" href="/teacher"
                                style="color: #FFB600;background: var(--bs-white);">
                                <i class="fas fa-chalkboard-teacher"
                                    style="color: #FFB600;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Teacher Management</span>
                            </a>
                            <!-- Teacher Coordinator -->
                ...
                <div id="content">
                    <div class="container-fluid">
                        ...
                        <a class="btn btn-primary m-3 " role="button"
                            ...
                            href="teacher/create">Add New Teacher</a>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: #16416E;font-weight: bold;">Teacher Name</th>
                            ...
                            ?>
                                <td>
                                    <a href="/teacher/{{$teacher->id}}"><i class="fa fa-eye mx-1"
                                            style="font-size: 17px" aria-hidden="true"></i></a>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#myModal{{$teacher->id}}"><i
                                            class="fa fa-trash text-danger mx-1" style="font-size: 17px"
                                            aria-hidden="true"></i></a>

                                    <!-- The Modal -->
                                    <div class="modal" id="myModal{{$teacher->id}}">
