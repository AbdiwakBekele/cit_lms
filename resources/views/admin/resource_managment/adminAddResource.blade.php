            ...
            <nav class="navbar navbar-dark bg-primary align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            <!-- Dashboard -->
                            <a class="nav-link" href="/admin"><i class="fas fa-trash-restore-alt"
                                    style="color: #16416E;font-size: 19px;margin: 0px 15px 0px 0px;width: 19px;"></i><span
                                    style="color: #16416E;font-size: 14px;font-weight: bold;">Dashboard</span>
                            </a>
                            <!-- Course Category -->
                            ...
                            <!-- Resource Managment -->
                            <a class="nav-link text-start bg-white active" href="/resource"
                                style="color: #FFB600;background: var(--bs-white);">
                                <i class="fas fa-th-large"
                                    style="color: #FFB600;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Resource Management</span>
                            </a>
                        </li>
                        <!-- Student Managment -->
                        <li class="nav-item">
                        ...
                        ?>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="file" class="form-control" id="course_resource"
                                    placeholder="Upload course resources" name="course_resource[]" multiple require>
