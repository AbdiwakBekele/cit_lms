                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="/registrar">
                                <i class="fas fa-sticky-note"
                                    ...
                                    style="color: #16416E;font-size: 14px;font-weight: bold;">Registrar
                                    Management</span>
                            </a>

                            <!-- Reception Managment -->
                            <a class="nav-link text-start bg-white active" href="/reception"
                                style="color: #FFB600;background: var(--bs-white);">
                                <i class="fas fa-receipt"
                                    style="color: #FFB600;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Reception Management</span>
                            </a>
                            <!-- Role Managment -->
                ...
                <div id="content">
                    <div class="container-fluid">
                        ...
                        <div class="m-3 p-3 ">
                            ...
                            <form action="/reception/{{$reception->id}}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="fullname" id="fullname"
                                        placeholder="Enter User's Fullname" value="{{$reception->fullname}}" required>
                                    @error('fullname')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="email" class="form-control" id="email"
                                        placeholder="Enter Email Address" name="email" value="{{$reception->email}}"
                                        required>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="number" class="form-control" id="age" placeholder="Enter Age"
                                        name="age" value="{{$reception->age}}" required>
                                    @error('age')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" placeholder="Enter Phone number"
                                        name="phone" value="{{$reception->phone}}" required>
                                    @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="address" placeholder="Enter Address"
                                        name="address" value="{{$reception->address}}" required>
                                    @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
