                ...
                <div id="content">
                    <div class="container-fluid">
                        ...
                        <a class="btn btn-primary m-3 " role="button"
                            ...
                            href="reception/create">Add New Reception</a>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: #16416E;font-weight: bold;">Reception Name</th>
                            ...
                            ?>
                                <td>
                                    <a href="/reception/{{$reception->id}}"><i class="fa fa-eye mx-1"
                                            style="font-size: 17px" aria-hidden="true"></i></a>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#myModal{{$reception->id}}"><i
                                            class="fa fa-trash text-danger mx-1" style="font-size: 17px"
                                            aria-hidden="true"></i></a>

                                    <!-- The Modal -->
                                    <div class="modal" id="myModal{{$reception->id}}">
