                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="/course">
                                ...
                                <span style="color: #16416E;font-size: 14px;font-weight: bold;">Course Management</span>
                            </a>
                            <!-- Resource Managment -->
                        ...
                        <li class="nav-item">
                            ...
                            <!-- Teacher Coordinator -->
                            <a class="nav-link text-start bg-white active" href="/teacherCoordinator"
                                style="color: #FFB600;background: var(--bs-white);">
                                <i class="fas fa-coins"
                                    style="color: #FFB600;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Teacher Coordinator</span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    <div class="container-fluid">
                        <h3 class="mb-4" style="margin: 26px;color: #16416E;font-size: 35px;font-weight: bold;">Teacher
                            Management</h3>
                        ...
                        <a class="btn btn-primary m-3 " role="button"
                            ...
                            href="teacherCoordinator/create">Add New Teacher</a>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: #16416E;font-weight: bold;">Coordinator Name</th>
                            ...
                            ?>
                                <td>
                                    <a href="/teacherCoordinator/{{$coordinator->id}}"><i class="fa fa-eye mx-1"
                                            style="font-size: 17px" aria-hidden="true"></i></a>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#myModal{{$coordinator->id}}"><i
                                            class="fa fa-trash text-danger mx-1" style="font-size: 17px"
                                            aria-hidden="true"></i></a>

                                    <!-- The Modal -->
                                    <div class="modal" id="myModal{{$coordinator->id}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer p-1">
                                                    <form action="/teacherCoordinator/{{$coordinator->id}}"
                                                        method="post">
                                                        {{ csrf_field() }}
