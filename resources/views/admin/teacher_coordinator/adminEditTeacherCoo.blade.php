                ...
                <div id="content">
                    <div class="container-fluid">
                        ...
                        <div class="m-3 p-3 ">
                            ...
                            <form action="/teacherCoordinator/{{$coordinator->id}}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="fullname" id="fullname"
                                        placeholder="Enter User's Fullname" value="{{$coordinator->fullname}}" required>
                                    @error('fullname')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="email" class="form-control" id="email"
                                        placeholder="Enter Email Address" name="email" value="{{$coordinator->email}}"
                                        required>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="number" class="form-control" id="age" placeholder="Enter Age"
                                        name="age" value="{{$coordinator->age}}" required>
                                    @error('age')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" placeholder="Enter Phone number"
                                        name="phone" value="{{$coordinator->phone}}" required>
                                    @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="address" placeholder="Enter Address"
                                        name="address" value="{{$coordinator->address}}" required>
                                    @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
