                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            ...
                            <!-- Course Management -->
                            <a class="nav-link" href="/course"><i class="fab fa-creative-commons-sampling"
                                    style="color: #16416E;font-size: 19px;margin: 0px 15px 0px 0px;width: 19px;"></i><span
                                    style="color: #16416E;font-size: 14px;font-weight: bold;">Course Management</span>
                            </a>
                            <!-- Resource Managment -->
                            ...
                            <!-- Batch Management -->
                            <a class="nav-link text-start bg-white active" href="/batch"
                                ...
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Batch Management</span>
                            </a>
                        </li>
                        <!-- Student Managment -->
                        <li class="nav-item">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <a class="btn btn-primary"
                                            href="/disapprove_student/{{$classroom->id}}">Dismiss</a>
