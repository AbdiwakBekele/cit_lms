                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="/registrar"><i class="fas fa-sticky-note"
                                    style="color: #16416E;font-size: 19px;width: 19px;margin: 0px 15px 0px 0px;font-weight: bold;"></i><span
                                    style="color: #16416E;font-size: 14px;font-weight: bold;">Registrar Managment
                                </span></a>
                            ...
                            <!-- Role Managment -->
                            <a class="nav-link text-start bg-white active" href="/role"
                                ...
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Role Management</span>
                            </a>
                        ...
                        <div class="m-3 p-3 ">
                            ...
                            <form action="/role/{{$role->id}}" method="post">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <textarea class="form-control" name="role_detail" id="role_detail" cols="30"
                                        rows="10" required>{{$role->role_detail}}</textarea>
                                    @error('role_detail')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
