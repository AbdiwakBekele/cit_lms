                            ...
                            <form action="/registrar/{{$registrar->id}}" method="post">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" name="fullname" id="fullname"
                                        placeholder="Enter User's Fullname" value="{{$registrar->fullname}}" required>
                                    @error('fullname')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="email" class="form-control" id="email"
                                        placeholder="Enter Email Address" name="email" value="{{$registrar->email}}"
                                        required>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="number" class="form-control" id="age" placeholder="Enter Age"
                                        name="age" value="{{$registrar->age}}" required>
                                    @error('age')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" placeholder="Enter Phone number"
                                        name="phone" value="{{$registrar->phone}}" required>
                                    @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="address" placeholder="Enter Address"
                                        name="address" value="{{$registrar->address}}" required>
                                    @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
