                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            ...
                            <!-- Course Category -->
                            <a class="nav-link text-start bg-white active" href="/courseCategory"
                                style="color: #FFB600;background: var(--bs-white);">
                                <i class="fas fa-bookmark"
                                    style="color: #FFB600;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Course Category</span>
                            </a>
                            <!-- Course Management -->
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content-1">
                    ...
                    <div class="container">
                        ...
                        <form action="/courseCategory/{{$category->id}}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class=" mb-3 mt-3">
                                ...
                                <input class="form-control" type="text" name="category_name"
                                    placeholder="Enter Course Category Name" value="{{$category->category_name}}"
                                    required>
                                @error('category_name')
                            ...
                            <div class="my-3">
                                ...
                                <textarea class="form-control" name="category_detail"
                                    placeholder="Enter Course Category Description" rows="5"
                                    required>{{$category->category_detail}}</textarea>
