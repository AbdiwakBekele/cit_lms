            ...
            <nav class="navbar navbar-dark bg-primary align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
                ...
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar-1" style="background: #D9D9D9;">
                        ...
                        <li class="nav-item">
                            <!-- Dashboard -->
                            <a class="nav-link" href="/admin" style="font-size: 14.6px;font-weight: bold;">
                                <i class="fas fa-user-alt"
                                    style="color: #16416E;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="color: #16416E;font-size: 14px;">Dashboard</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-start bg-white active" href="/student"
                                style="color: #FFB600;background: var(--bs-white);">
                                <i class="fas fa-th-large"
                                    style="color: #FFB600;font-size: 19px;margin: 0px 15px 0px 0px;">
                                </i>
                                <span style="font-size: 14px;color: rgb(255, 182, 0);">Student Management</span>
                            </a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <a href="/student/{{$student->id}}"><i class="fa fa-eye mx-1"
