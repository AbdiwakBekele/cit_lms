...
<div class="container">
                    ...
                    <div class="col-md-8">
                        ...
                        <div id="questions">
                            ...
                            <div class="question" style="display:none; ">
                                ...
                                <div class="form_header_content text-center pt-4" style="padding-top: 0.625rem;">
                                  <h2>QUIZ</h2>
                                  <span>Fill out this quiz for fun!</span>
                                </div>  
                                <span class="question_number text-uppercase mb-3 float-end">QUESTION 1/4</span>
         <div class="progress rounded-pill">
            <div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    ...
                                    <div class="card-header">
                                        <h2 class="px-5 py-3" style="text-align: justify; color: #000a38;font-size: 1.75rem; font-weight: 700;" >{{ $question->question }}</h2>
                                    </div>
                                ...
                                <div class="form_btn py-5 text-center">
      <button type="button" class="f_btn disable text-uppercase rounded-pill text-white" id="prevBtn" onclick="nextQuestion()"><span><i class="fas fa-arrow-left"></i></span> Last Question</button>
      <button type="button" class="f_btn active text-uppercase rounded-pill text-white" id="nextBtn" onclick="nextQuestion(0)"> Next Question <i class="fas fa-arrow-right"></i></button>
   </div>
