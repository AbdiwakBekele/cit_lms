...
<body>
        ...
        <div class="row justify-content-center">
            ...
            <div id="questions">
                ...
                <div class="question" style="display:none;">
                    <strong>
                        <h4 style="text-align:center">Question No: {{++$index}} / {{$questions->count()}}</h4>
                    </strong>
                    ...
                    <div class="card-body">
                        ...
                        <form id="match_form_{{$question->id}}">
                ...
                <!-- Previous Button -->
                <button type="button" id="previous_btn" class="btn btn-primary float-start mx-3"
            ...
            <div class="d-flex justify-content-center">
                <button class="btn btn-success m-3" id="btn_submit" type="submit">Submit</button> <br>
                <button type="button" class="btn btn-primary m-3" id="go_back_btn"> Go Back </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Previous Button
        var pervious_btn = document.getElementById("previous_btn");
        previous_btn.style.display = 'none'; // Initial dislplay none

        // Go Back Button go_back_btn
        var go_back_btn = document.getElementById("go_back_btn");
        go_back_btn.style.display = 'none'; // Initial dislplay none
        ...
        pervious_btn.addEventListener('click', function() {
        ...
        // Submit Each Answer (Choose and Short Answer)
        ...
        function submitMatchAnswer(classroomId, questionId) {
            ...
            var checkboxes = document.querySelectorAll(
                `#match_form_${questionId} input[type="checkbox"]:checked`
            );
